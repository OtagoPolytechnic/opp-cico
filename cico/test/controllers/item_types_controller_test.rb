...
class ItemTypesControllerTest < ActionController::TestCase
  ...
  test "should create item_type" do
    assert_difference('ItemType.count') do
      post :create, item_type: {  name: @item_type. name, description: @item_type.description, notes: @item_type.notes, retire_date: @item_type.retire_date }
    end
  ...
  test "should update item_type" do
    patch :update, id: @item_type, item_type: {  name: @item_type. name, description: @item_type.description, notes: @item_type.notes, retire_date: @item_type.retire_date }
    assert_redirected_to item_type_path(assigns(:item_type))
  end
